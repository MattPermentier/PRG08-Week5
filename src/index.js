...
let duim = document.getElementById('duim')
let middelvinger = document.getElementById('middelvinger')

function duimButtonHandler(e) {
    e.preventDefault();
    console.log('Duim inscannen')
    machine.learn(predictionsArray, 'duim')
}

function middelvingerButtonHandler(e) {
    e.preventDefault();
    console.log('Middelvinger inscannen')
    machine.learn(predictionsArray, 'middelvinger')
}
...
function logData(predictions) {
    duim.addEventListener('click', (event) => duimButtonHandler(event, predictions));
    middelvinger.addEventListener('click', (event) => middelvingerButtonHandler(event, predictions));
    ...
    if (prediction === undefined) {
        log.innerText = 'Scan eerst je duim en middelvinger in';
    } else {
        log.innerText = prediction;
    }
}
